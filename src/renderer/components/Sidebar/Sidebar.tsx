  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-white dark:bg-dark-sidebar border-l border-slate-200/80 dark:border-white/5 flex flex-col h-full select-none z-20">
      ...
      <div className="p-6 flex items-center gap-3 border-b border-slate-200/80 dark:border-white/5">
        <div className="w-10 h-10 rounded-xl overflow-hidden shadow-lg shadow-brand-500/15 border border-brand-500/30 flex-shrink-0 bg-emerald-50 dark:bg-dark-card flex items-center justify-center">
          <img src="/icon.png" alt="Quran Desktop" className="w-full h-full object-cover" />
        </div>
        <div>
          <h1 className="font-bold text-lg text-slate-800 dark:text-slate-100 tracking-wide flex items-center gap-1.5 font-cairo">
            قرآني
            <span className="text-[10px] px-2 py-0.5 rounded-full bg-brand-500/10 text-brand-600 dark:text-brand-400 border border-brand-500/20 font-sans">
              Desktop
            </span>
          </h1>
      ...
      <div className="p-4 m-3 rounded-2xl bg-gradient-to-b from-brand-50 to-slate-100/80 dark:from-brand-950/40 dark:to-dark-card border border-brand-500/20 shadow-sm">
        <div className="flex items-center gap-2 mb-1.5">
          <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping" />
          <span className="text-xs font-semibold text-brand-700 dark:text-brand-300">متصل بـ MP3Quran</span>
        </div>
